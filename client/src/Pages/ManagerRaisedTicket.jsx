...
const ManagerRaisedTicket = () => {
  ...
  const handleRowClick = (ticketId) => {
    navigate(`/managerticket/${ticketId}`);
  };
  ...
  return (
    <ManagerLayout>
      <div className="bg-gray-100 min-h-screen">
        <div className="w-full mb-4 pb-3 px-4 bg-gradient-to-r from-blue-800 to-blue-300 shadow-lg rounded-lg">
          <h1 className="text-2xl pt-4 font-bold text-white">
            All Tickets You Have Raised
          </h1>
...
export default ManagerRaisedTicket;
